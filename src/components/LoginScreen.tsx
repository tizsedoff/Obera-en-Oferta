            ...
            >
              {role === 'merchant' ? (
                <>
                  ...
                  <p><span className="font-bold">Responsabilidad exclusiva:</span> Sos el único responsable legal por la veracidad, los precios (con IVA incluido), el stock y la vigencia de los productos o servicios que publiques. Oberá en Oferta es únicamente un canal de difusión publicitaria y no participa en la venta.</p>
                  ...
                  <p><span className="font-bold">Mantené tu información actualizada:</span> Sos responsable de actualizar en el momento los precios, el stock y la vigencia de tus publicaciones. La plataforma no garantiza que la información se muestre en tiempo real ni se hace responsable por desactualizaciones que no hayas reportado.</p>
                  <p><span className="font-bold">Vigencia y condiciones de tus cupones:</span> Vos definís la validez, caducidad y restricciones de cada cupón u oferta (por ejemplo "válido de lunes a miércoles" o "hasta agotar stock"). Esas condiciones deben quedar redactadas de forma clara y visible en la descripción de la oferta; sos responsable de respetarlas y de que no induzcan a error al usuario.</p>
                  ...
                  <p><span className="font-bold">Legalidad del comercio y propiedad intelectual:</span> Garantizás contar con las habilitaciones municipales e inscripciones fiscales correspondientes (AFIP/ATM) para ejercer tu actividad comercial, y que tenés permiso legal para comercializar los productos o servicios que publicás. Las fotos e imágenes que subas deben ser propias o contar con autorización de uso; sos el único responsable ante cualquier reclamo por infracción de derechos de autor o de marca de terceros.</p>
                ...
                <>
                  ...
                  <p><span className="font-bold">Somos una vitrina publicitaria:</span> Oberá en Oferta no vende productos, no procesa pagos ni cobra comisiones. Toda compra o reserva se realiza directamente entre vos y el comercio local, y es el único responsable de la oferta.</p>
                  <p><span className="font-bold">Exclusión de responsabilidad por stock y precios:</span> Las ofertas publicadas son responsabilidad exclusiva del comercio que las carga. Si el comercio no respeta el precio, el stock o las condiciones anunciadas, Oberá en Oferta no es responsable por esa falta; te recomendamos reportarla con nuestro botón de reporte.</p>
                  <p><span className="font-bold">La información puede no estar 100% actualizada:</span> Los precios y la disponibilidad de cada oferta pueden variar sin previo aviso según lo que decida el comercio. No garantizamos que la información se muestre en tiempo real; verificá siempre las condiciones con el local antes de pagar.</p>
                  <p><span className="font-bold">Vigencia de los cupones:</span> Si descargás o reservás un cupón, su validación, condiciones de uso y caducidad dependen exclusivamente de lo que haya definido el comercio para esa oferta (por ejemplo, días de vigencia o "hasta agotar stock").</p>
                  ...
                  <p><span className="font-bold">Tus datos están seguros:</span> Tus datos personales de navegación se protegen bajo la Ley N° 25.326 y se usan exclusivamente para mejorar tu experiencia en el sitio. No se venden a terceros. Al reservar o canjear un cupón solo generamos un código único para validarlo en el local; no compartimos tu nombre, email ni otros datos personales con el comercio salvo que vos se los entregues directamente.</p>
